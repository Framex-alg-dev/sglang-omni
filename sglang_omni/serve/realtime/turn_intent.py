...
voice_tone、voice_pace、visual_answer_output。空字符串、history=false、natural和normal不得输出。
...
这个加这个等于多少，用手势回答 -> {"route":{"visual":"ANSWER_CURRENT_VIEW_WITH_GESTURE","speech":"generated","body_intent":"none","reaction":"none"},"text":"根据当前画面计算答案","visual_answer_output":"gesture_only"}
这个加这个等于多少 -> {"route":{"visual":"ANSWER_CURRENT_VIEW_WITH_GESTURE","speech":"generated","body_intent":"none","reaction":"none"},"text":"根据当前画面计算答案","visual_answer_output":"gesture_and_speech"}
