...
ACTION_SCENARIOS: list[dict[str, Any]] = [
    {"id": "wave-left", "expected_action": "wave_left", "turns": ["你好，我们来聊聊天吧。", "见到你很开心，请用左手抬起举高，手掌向外，左右摆动挥手向我打招呼。"]},
    {"id": "wave-right", "expected_action": "wave_right", "turns": ["你好，我们来聊聊天吧。", "见到你很开心，请用右手抬起举高，手掌向外，左右摆动挥手向我打招呼。"]},
    {"id": "wave-both", "expected_action": "wave_both", "turns": ["今天是值得庆祝的一天。", "太棒了，请把双手抬起举高，手掌向外，左右摆动挥手庆祝。"]},
    {"id": "laugh", "expected_action": "laugh", "turns": ["我刚刚讲了一个笑话。", "这个笑话太逗了，请张大嘴巴大笑，肩膀随着笑意起伏。"]},
    {"id": "heart-both", "expected_action": "heart_both", "turns": ["谢谢你一直陪我聊天。", "谢谢你的陪伴，请双手弯曲相扣，比出一个完整的爱心形状。"]},
    {"id": "thumbs-left", "expected_action": "thumbs_up_left", "turns": ["我刚刚完成了任务。", "我这次做得好吗，请用左手握空拳，只把拇指竖起向前给我点赞。"]},
    {"id": "thumbs-right", "expected_action": "thumbs_up_right", "turns": ["我刚刚完成了任务。", "我这次做得好吗，请用右手握空拳，只把拇指竖起向前给我点赞。"]},
    {"id": "number-1", "expected_action": "number_1", "turns": ["我们来做一个简单的数字练习。", "请使用右手，食指独立伸出，比出数字一。"]},
    {"id": "number-2", "expected_action": "number_2", "turns": ["我们来做一个简单的数字练习。", "请使用右手，食指和中指伸出，比出数字二。"]},
    {"id": "number-3", "expected_action": "number_3", "turns": ["我们来做一个简单的数字练习。", "请使用右手，食指、中指和无名指伸出，比出数字三。"]},
    {"id": "number-4", "expected_action": "number_4", "turns": ["我们来做一个简单的数字练习。", "请使用右手，四指并拢伸出，比出数字四。"]},
    {"id": "number-5", "expected_action": "number_5", "turns": ["我们来做一个简单的数字练习。", "请使用右手，五指全部张开，比出数字五。"]},
